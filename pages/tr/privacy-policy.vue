    ...
    <main class="policy-content">
      <div class="container">
        ...
        <div class="policy-body">
          ...
          <section class="policy-section">
            <h2>4. Bilgileri Nasıl Topluyoruz</h2>
            <p>Bilgi toplama, kapsamlı hizmet sunumunu sağlamak için birden fazla kanal aracılığıyla gerçekleşir. Doğrudan toplama, bir hesap oluştururken, profilinizi güncellerken, düzenleme için el yazmaları gönderirken, istatistiksel analiz hizmetleri talep ederken, eğitim programlarına kaydolurken veya destek ekibimizle iletişim kurarken gönüllü olarak bilgi sağladığınızda gerçekleşir.</p>
          </section>
          ...
          <section class="policy-section">
            <h2>12. Bu Politikadaki Değişiklikler</h2>
            <p>Bu Gizlilik Politikası, uygulamalarımızdaki, teknolojilerimizdeki, yasal gerekliliklerdeki veya işletme operasyonlarımızdaki değişiklikleri yansıtmak için periyodik olarak güncellenebilir.</p>
          </section>
...
export default {
  ...
  methods: {
    toggleLanguage() {
      ...
      this.$router.push(`/${newLang}/privacy-policy`);
    }
  }
}
</script>
