    ...
    <main class="terms-content">
      <div class="container">
        <div class="terms-header">
          ...
          <p class="effective-date">Yürürlük Tarihi: 27 Eylül 2025</p>
        </div>
        ...
        <div class="terms-body">
          ...
          <section class="terms-section">
            <h2>9. Hesap Sonlandırma ve Askıya Alma</h2>
            <p>Hesabınızı ve Platforma erişiminizi, sebep göstermeksizin, bildirimde bulunarak veya bulunmadan, istediğimiz zaman askıya alma veya sonlandırma hakkını saklı tutarız. Sonlandırma nedenleri, bu Şartların ihlalini, uzun süreli hareketsizliği, kolluk kuvvetleri veya devlet kurumlarının taleplerini, teknik veya güvenlik sorunlarını veya şüpheli dolandırıcılık veya yasa dışı faaliyetleri içerebilir ancak bunlarla sınırlı değildir.</p>
          </section>
          ...
          <section class="terms-section">
            <h2>12. Uygulanabilir Hukuk ve Uyuşmazlık Çözümü</h2>
            <p>Bu Şartlar, çatışma hukuku hükümleri hariç olmak üzere, [Belirlenecek Yargı] yasalarına göre yönetilecek ve yorumlanacaktır. Bu Şartlardan veya Platformunuzun kullanımından kaynaklanan herhangi bir uyuşmazlığın münhasıran [Belirlenecek Tahkim Kurulu] kurallarına uygun olarak bağlayıcı tahkim yoluyla çözüleceğini kabul edersiniz.</p>
          </section>
...
export default {
  ...
  methods: {
    toggleLanguage() {
      ...
      this.$router.push(`/${newLang}/terms-of-service`);
    }
  }
}
</script>
